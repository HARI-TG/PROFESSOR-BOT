...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://appas:appas@cluster0.kydcruw.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "appas")
